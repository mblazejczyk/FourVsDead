...
namespace RedlabsUpdateUtility
{
	...
	*/
	...
	/// <summary>
	/// Downloads files from the internet. Required if you are downloading from Google
	/// Drive because Google Drive displays a possible virus warning if the file is large,
	/// and this script is needed to bypass it.
	/// </summary>
